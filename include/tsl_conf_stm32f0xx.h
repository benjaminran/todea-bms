...
/** Delay for discharging Cx and Cs capacitors (range=0..65535)
    ...
    -  500 gives around  53 �s delay whatever HCLK
    - 1000 gives around 106 �s delay whatever HCLK
    - 2000 gives around 210 �s delay whatever HCLK
*/
...
#define TSLPRM_TSC_GROUP2_IO1  CHANNEL       // PA4
#define TSLPRM_TSC_GROUP2_IO2  CHANNEL       // PA5
#define TSLPRM_TSC_GROUP2_IO3  CHANNEL       // PA6
#define TSLPRM_TSC_GROUP2_IO4  SAMPCAP       // PA7
