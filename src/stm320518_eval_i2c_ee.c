/**
  ...
  *          EEPROM memory.
  *          This is a modified version for the ElectroDacus SBMS4080 project.
  *          
  *          ===================================================================
  *          Notes: 
...
{   
  ...
  /* Configure slave address, nbytes, reload and generate start reload_mode*/
  I2C_TransferHandling(sEE_I2C, sEEAddress, 1, I2C_Reload_Mode, I2C_Generate_Start_Write);
